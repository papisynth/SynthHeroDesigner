  ...
  public class frmMain : Form
  {
      ...
      else
      {
        ...
        if (flag)
        {
          ...
          for (int iIDXPower = 0; iIDXPower <= num; ++iIDXPower)
          {
            ...
            {
              message = "";
              ListLabelV2.ListLabelItemV2 iItem2 = new ListLabelV2.ListLabelItemV2(powerset.Powers[iIDXPower].DisplayName, MainModule.MidsController.Toon.PowerState(powerset.Powers[iIDXPower].PowerIndex, ref message), Powerset.nIDTrunkSet, iIDXPower, powerset.Powers[iIDXPower].PowerIndex, "", ListLabelV2.LLFontFlags.Bold, ListLabelV2.LLTextAlign.Left) { Bold = MidsContext.Config.RtFont.PairedBold };
    ...
    private void frmMain_Load(object sender, EventArgs e)
    {
      try
      {
        ...
        if (File.Exists(str2))
        {
          int num2 = (int) new frmReadme(str2) { btnClose = { IA = this.Drawing.pImageAttributes, ImageOff = this.Drawing.bxPower[2].Bitmap, ImageOn = this.Drawing.bxPower[3].Bitmap } }.ShowDialog();
    ...
    {
      I9Slot i9Slot = new I9Slot() { Enh = e, IOLevel = this.I9Picker.CheckAndReturnIOLevel() - 1, Grade = this.I9Picker.UI.View.GradeID, RelativeLevel = this.I9Picker.UI.View.RelLevel };
    ...
    private void InitializeComponent()
    {
      ...
      this.tsTitanPlanner.Text = "CoH Planner";
...
label_133:
    ...
    private void SetTitleBar(bool Hero = true)
    {
      ...
      if (MainModule.MidsController.Toon != null)
      {
        ...
        this.tsFileSave.Text = "&Save";
      string str2 = str1 + "Synth's Hero Designer";
      if (!Hero)
    ...
    private bool ToggleClicked(int hID, int iX, int iY)
    {
      ...
      {
        Rectangle rectangle2 = new Rectangle() { Location = this.Drawing.PowerPosition(MidsContext.Character.CurrentBuild.Powers[hID], -1), Size = this.Drawing.bxPower[0].Size };
    ...
    {
      this.FloatTop(false);
      int num = (int) new frmAbout() { ibClose = { IA = this.Drawing.pImageAttributes, ImageOff = this.Drawing.bxPower[2].Bitmap, ImageOn = this.Drawing.bxPower[3].Bitmap } }.ShowDialog((IWin32Window) this);
      this.FloatTop(true);
    }
    ...
    {
      frmReadme frmReadme = new frmReadme(OS.GetApplicationPath() + "readme.rtf") { btnClose = { IA = this.Drawing.pImageAttributes, ImageOff = this.Drawing.bxPower[2].Bitmap, ImageOn = this.Drawing.bxPower[3].Bitmap } };
      this.FloatTop(false);
    ...
    private void tsPatchNotes_Click(object sender, EventArgs e)
    {
      ...
      if (File.Exists(str))
      {
        frmReadme frmReadme = new frmReadme(str) { btnClose = { IA = this.Drawing.pImageAttributes, ImageOff = this.Drawing.bxPower[2].Bitmap, ImageOn = this.Drawing.bxPower[3].Bitmap } };
        this.FloatTop(false);
        int num = (int) frmReadme.ShowDialog((IWin32Window) this);
        this.FloatTop(true);
      }
