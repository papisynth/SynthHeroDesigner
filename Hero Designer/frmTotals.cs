...
namespace Hero_Designer
{
  ...
  public class frmTotals : Form
  {
    ...
    public void UpdateData()
    {
      ...
      Enums.eMez[] eMezArray = new Enums.eMez[11]{ Enums.eMez.Held, Enums.eMez.Stunned, Enums.eMez.Sleep, Enums.eMez.Immobilized, Enums.eMez.Knockback, Enums.eMez.Repel, Enums.eMez.Confused, Enums.eMez.Terrorized, Enums.eMez.Taunt, Enums.eMez.Placate, Enums.eMez.Teleport };
      ...
      Enums.eEffectType[] eEffectTypeArray = new Enums.eEffectType[7]{ Enums.eEffectType.Defense, Enums.eEffectType.Endurance, Enums.eEffectType.Recovery, Enums.eEffectType.PerceptionRadius, Enums.eEffectType.ToHit, Enums.eEffectType.RechargeTime, Enums.eEffectType.SpeedRunning };
