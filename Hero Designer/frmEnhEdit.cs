    ...
    private void AddListItem(int Index)
    {
      ...
      for (int index1 = 0; index1 <= num1; ++index1)
      {
        if (items[3] != "")
        {
          ...
          string[] strArray2;
          IntPtr index2;
          (strArray2 = strArray1)[(int) (index2 = (IntPtr) num2)] = strArray2[index2.ToInt64()] + ",";
        }
        string[] strArray3 = items;
        int num3 = 3;
        string[] strArray4;
        IntPtr index3;
        (strArray4 = strArray3)[(int) (index3 = (IntPtr) num3)] = strArray4[index3.ToInt64()] + DatabaseAPI.Database.EnhancementClasses[enhancement.ClassID[index1]].ShortName;
      }
    ...
    private void UpdateListItem(int Index)
    {
      ...
      for (int index1 = 0; index1 <= num1; ++index1)
      {
        if (strArray1[3] != "")
        {
          ...
          string[] strArray3;
          IntPtr index2;
          (strArray3 = strArray2)[(int) (index2 = (IntPtr) num2)] = strArray3[index2.ToInt64()] + ",";
        }
        string[] strArray4 = strArray1;
        int num3 = 3;
        string[] strArray5;
        IntPtr index3;
        (strArray5 = strArray4)[(int) (index3 = (IntPtr) num3)] = strArray5[index3.ToInt64()] + DatabaseAPI.Database.EnhancementClasses[enhancement.ClassID[index1]].ShortName;
      }
      if (enhancement.nIDSet > -1)
      {
