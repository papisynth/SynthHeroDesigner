...
namespace Hero_Designer
{
  public class clsOutput
  {
    ...
    public string Build(string iDataLink)
    {
      ...
      string str3 = str1 + this.formatColor(this.formatBold(str2 + " Plan by Mids' " + str2 + " Designer " + Strings.Format((object) 1.962f, "##0.00#####")), ExportConfig.Element.Heading) + this.LineBreak() + this.formatColor(this.formatBold("http://www.cohplanner.com/"), ExportConfig.Element.Heading) + this.LineBreak();
