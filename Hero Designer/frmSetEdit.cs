      ...
      for (int imageIndex = 0; imageIndex <= num1; ++imageIndex)
      {
        ...
        for (int index1 = 0; index1 <= num2; ++index1)
        {
          if (items[1] != "")
          {
            ...
            string[] strArray2;
            IntPtr index2;
            (strArray2 = strArray1)[(int) (index2 = (IntPtr) num3)] = strArray2[index2.ToInt64()] + ",";
          }
          string[] strArray3 = items;
          int num4 = 1;
          string[] strArray4;
          IntPtr index3;
          (strArray4 = strArray3)[(int) (index3 = (IntPtr) num4)] = strArray4[index3.ToInt64()] + DatabaseAPI.Database.EnhancementClasses[enhancement.ClassID[index1]].ShortName;
        }
